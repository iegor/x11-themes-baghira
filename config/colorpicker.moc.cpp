...
**
** Created: Sun Apr 8 21:58:32 2012
...
QMetaObject* ColorPicker::staticMetaObject()
{
    ...
    static const QUMethod slot_2 = {"emitChange", 0, 0 };
    static const QUParameter param_slot_3[] = {
	{ "green", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_3 = {"setGreen", 1, param_slot_3 };
    static const QUParameter param_slot_4[] = {
	{ "blue", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_4 = {"setBlue", 1, param_slot_4 };
	...
	{ "emitChange()", &slot_2, QMetaData::Public },
	{ "setGreen(int)", &slot_3, QMetaData::Public },
	{ "setBlue(int)", &slot_4, QMetaData::Public },
	{ "reset()", &slot_5, QMetaData::Public },
	{ "init()", &slot_6, QMetaData::Public }
    };
