...
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = bab colorscheme config deco icons sessionapplet starter \
	style kickermenu-3.3 kickermenu sidebar
...
#>+ 2
KDE_DIST=stamp-h.in cleanMySystem subdirs Makefile.in configure.files cvsignores.tar.gz config.h.in install.sh babstart baghira configure.in Makefile.cvs updatePredefs 2005-09-01 aclocal.m4 acinclude.m4 configure Makefile.am 
